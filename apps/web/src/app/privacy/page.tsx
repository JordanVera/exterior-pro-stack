  ...
  return (
    <main className="max-w-3xl px-5 py-16 mx-auto">
      ...
      <div className="mt-8 space-y-4 text-sm leading-relaxed text-neutral-700 dark:text-neutral-300">
        <p>
          Exterior Pro collects the information needed to operate a property-services
          marketplace: phone number, name, email, property addresses, job details,
          payment records, and device push tokens.
        </p>
        ...
        <p>
          We retain account, job, and payment records as required for tax, dispute,
          and operational purposes. You may request deletion of your account by
          contacting support, subject to legal retention needs.
        </p>
        <p>
